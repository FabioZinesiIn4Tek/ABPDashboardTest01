...
public class DashBoardTest01DatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public DashBoardTest01DatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
